...
bool amr_fleet_msgs__msg__rolling_horizon_plan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_fleet_msgs.msg._rolling_horizon_plan.RollingHorizonPlan", full_classname_dest, 59) == 0);
  }
  amr_fleet_msgs__msg__RollingHorizonPlan * ros_message = _ros_message;
  {  // header
  ...
  {  // assigned_bundle
    PyObject * field = PyObject_GetAttrString(_pymsg, "assigned_bundle");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'assigned_bundle'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->assigned_bundle.data;
  ...
  {  // current_goal
    ...
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->current_goal)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of RollingHorizonPlan */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_fleet_msgs.msg._rolling_horizon_plan");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RollingHorizonPlan");
  ...
  {  // assigned_bundle
    ...
    rosidl_runtime_c__String * src = ros_message->assigned_bundle.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "assigned_bundle", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // current_goal
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->current_goal);
    if (!field) {
      return NULL;
    }
    {
