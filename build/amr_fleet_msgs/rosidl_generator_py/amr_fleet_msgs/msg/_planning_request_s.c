...
bool amr_fleet_msgs__msg__planning_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_fleet_msgs.msg._planning_request.PlanningRequest", full_classname_dest, 52) == 0);
  }
  amr_fleet_msgs__msg__PlanningRequest * ros_message = _ros_message;
  {  // header
  ...
  {  // start_pose
    ...
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->start_pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // goal_pose
    ...
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->goal_pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * amr_fleet_msgs__msg__planning_request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_fleet_msgs.msg._planning_request");
  ...
  {  // start_pose
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->start_pose);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // goal_pose
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->goal_pose);
    if (!field) {
      return NULL;
    }
    {
