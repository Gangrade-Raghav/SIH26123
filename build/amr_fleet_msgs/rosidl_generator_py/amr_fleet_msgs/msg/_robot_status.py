    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'amr_fleet_msgs.msg.RobotStatus')
            logger.debug(
...
class RobotStatus(metaclass=Metaclass_RobotStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.plan_epoch = kwargs.get('plan_epoch', int())
    ...
    def __eq__(self, other):
        ...
        if self.state != other.state:
            return False
        if self.plan_epoch != other.plan_epoch:
            return False
    ...
    @builtins.property
    def plan_epoch(self):
        """Message field 'plan_epoch'."""
        return self._plan_epoch

    @plan_epoch.setter
    def plan_epoch(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'plan_epoch' field must be of type 'int'"
            assert value >= 0 and value < 18446744073709551616, \
                "The 'plan_epoch' field must be an unsigned integer in [0, 18446744073709551615]"
        self._plan_epoch = value
