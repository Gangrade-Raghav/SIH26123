...
bool amr_fleet_msgs__msg__task_assignment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_fleet_msgs.msg._task_assignment.TaskAssignment", full_classname_dest, 50) == 0);
  }
  amr_fleet_msgs__msg__TaskAssignment * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TaskAssignment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_fleet_msgs.msg._task_assignment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskAssignment");
