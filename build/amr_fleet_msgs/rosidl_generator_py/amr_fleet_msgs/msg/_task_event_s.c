...
bool amr_fleet_msgs__msg__task_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_fleet_msgs.msg._task_event.TaskEvent", full_classname_dest, 40) == 0);
  }
  amr_fleet_msgs__msg__TaskEvent * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TaskEvent */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_fleet_msgs.msg._task_event");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskEvent");
