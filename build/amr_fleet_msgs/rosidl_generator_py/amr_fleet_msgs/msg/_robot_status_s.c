...
bool amr_fleet_msgs__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_fleet_msgs.msg._robot_status.RobotStatus", full_classname_dest, 44) == 0);
  }
  amr_fleet_msgs__msg__RobotStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // plan_epoch
    PyObject * field = PyObject_GetAttrString(_pymsg, "plan_epoch");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->plan_epoch = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // battery_percentage
...
PyObject * amr_fleet_msgs__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_fleet_msgs.msg._robot_status");
  ...
  {  // plan_epoch
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->plan_epoch);
    {
      int rc = PyObject_SetAttrString(_pymessage, "plan_epoch", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
