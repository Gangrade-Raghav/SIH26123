...
class Metaclass_TaskList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from amr_fleet_msgs.msg import TaskDefinition
            if TaskDefinition.__class__._TYPE_SUPPORT is None:
                TaskDefinition.__class__.__import_type_support__()
...
class TaskList(metaclass=Metaclass_TaskList):
    ...
    _fields_and_field_types = {
        ...
        'tasks': 'sequence<amr_fleet_msgs/TaskDefinition>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['amr_fleet_msgs', 'msg'], 'TaskDefinition')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, TaskDefinition) for v in value) and
                 True), \
                "The 'tasks' field must be a set or sequence and each value of type 'TaskDefinition'"
        self._tasks = value
