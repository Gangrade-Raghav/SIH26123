...
class Metaclass_InjectFault_Event(type):
    """Metaclass of message 'InjectFault_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__inject_fault__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__inject_fault__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__inject_fault__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__inject_fault__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__inject_fault__event
...
class InjectFault_Event(metaclass=Metaclass_InjectFault_Event):
    """Message class 'InjectFault_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<amr_fleet_msgs/InjectFault_Request, 1>',
        'response': 'sequence<amr_fleet_msgs/InjectFault_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['amr_fleet_msgs', 'srv'], 'InjectFault_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['amr_fleet_msgs', 'srv'], 'InjectFault_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from amr_fleet_msgs.srv import InjectFault_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, InjectFault_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'InjectFault_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from amr_fleet_msgs.srv import InjectFault_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, InjectFault_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'InjectFault_Response'"
...
class Metaclass_InjectFault(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'amr_fleet_msgs.srv.InjectFault')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from amr_fleet_msgs.srv import _inject_fault
            ...
            if _inject_fault.Metaclass_InjectFault_Event._TYPE_SUPPORT is None:
                _inject_fault.Metaclass_InjectFault_Event.__import_type_support__()


class InjectFault(metaclass=Metaclass_InjectFault):
    from amr_fleet_msgs.srv._inject_fault import InjectFault_Request as Request
    from amr_fleet_msgs.srv._inject_fault import InjectFault_Response as Response
    from amr_fleet_msgs.srv._inject_fault import InjectFault_Event as Event
