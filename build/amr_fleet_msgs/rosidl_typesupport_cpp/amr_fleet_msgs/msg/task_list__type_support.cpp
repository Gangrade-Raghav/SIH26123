...
static const _TaskList_type_support_symbol_names_t _TaskList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, TaskList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_fleet_msgs, msg, TaskList)),
  }
};
...
{
  return &::amr_fleet_msgs::msg::rosidl_typesupport_cpp::TaskList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, amr_fleet_msgs, msg, TaskList)() {
  return get_message_type_support_handle<amr_fleet_msgs::msg::TaskList>();
}
