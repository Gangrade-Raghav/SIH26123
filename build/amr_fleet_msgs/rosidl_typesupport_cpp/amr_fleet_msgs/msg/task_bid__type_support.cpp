...
static const _TaskBid_type_support_symbol_names_t _TaskBid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, TaskBid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_fleet_msgs, msg, TaskBid)),
  }
};
...
{
  return &::amr_fleet_msgs::msg::rosidl_typesupport_cpp::TaskBid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, amr_fleet_msgs, msg, TaskBid)() {
  return get_message_type_support_handle<amr_fleet_msgs::msg::TaskBid>();
}
