...
static const _FleetMetrics_type_support_symbol_names_t _FleetMetrics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_fleet_msgs, msg, FleetMetrics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, amr_fleet_msgs, msg, FleetMetrics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, amr_fleet_msgs, msg, FleetMetrics)() {
  return &::amr_fleet_msgs::msg::rosidl_typesupport_c::FleetMetrics_message_type_support_handle;
}
