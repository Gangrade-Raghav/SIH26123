...
#include "amr_fleet_msgs/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // robot_id, state
#include "rosidl_runtime_c/string_functions.h"  // robot_id, state
...
using _RobotStatus__ros_msg_type = amr_fleet_msgs__msg__RobotStatus;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs__msg__RobotStatus;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const amr_fleet_msgs__msg__RobotStatus * ros_message = static_cast<const amr_fleet_msgs__msg__RobotStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_amr_fleet_msgs__msg__RobotStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  amr_fleet_msgs__msg__RobotStatus * ros_message = static_cast<amr_fleet_msgs__msg__RobotStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_amr_fleet_msgs__msg__RobotStatus(cdr, ros_message);
}

static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_fleet_msgs__msg__RobotStatus(
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amr_fleet_msgs__msg__RobotStatus(
