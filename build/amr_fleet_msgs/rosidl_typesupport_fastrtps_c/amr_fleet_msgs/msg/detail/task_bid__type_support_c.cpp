...
#include "amr_fleet_msgs/msg/detail/task_bid__rosidl_typesupport_fastrtps_c.h"
...
using _TaskBid__ros_msg_type = amr_fleet_msgs__msg__TaskBid;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
bool cdr_serialize_amr_fleet_msgs__msg__TaskBid(
  const amr_fleet_msgs__msg__TaskBid * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: path_cost
  {
    cdr << ros_message->path_cost;
  }

  // Field name: allocation_epoch
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
bool cdr_deserialize_amr_fleet_msgs__msg__TaskBid(
  eprosima::fastcdr::Cdr & cdr,
  amr_fleet_msgs__msg__TaskBid * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
size_t get_serialized_size_amr_fleet_msgs__msg__TaskBid(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
size_t max_serialized_size_amr_fleet_msgs__msg__TaskBid(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs__msg__TaskBid;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
bool cdr_serialize_key_amr_fleet_msgs__msg__TaskBid(
  const amr_fleet_msgs__msg__TaskBid * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
size_t get_serialized_size_key_amr_fleet_msgs__msg__TaskBid(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskBid__ros_msg_type * ros_message = static_cast<const _TaskBid__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_fleet_msgs
size_t max_serialized_size_key_amr_fleet_msgs__msg__TaskBid(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const amr_fleet_msgs__msg__TaskBid * ros_message = static_cast<const amr_fleet_msgs__msg__TaskBid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_amr_fleet_msgs__msg__TaskBid(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  amr_fleet_msgs__msg__TaskBid * ros_message = static_cast<amr_fleet_msgs__msg__TaskBid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_amr_fleet_msgs__msg__TaskBid(cdr, ros_message);
}

static uint32_t _TaskBid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_fleet_msgs__msg__TaskBid(
...
static size_t _TaskBid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amr_fleet_msgs__msg__TaskBid(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_fleet_msgs, msg, TaskBid)() {
