...
#include "amr_fleet_msgs/msg/detail/task_assignment__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amr_fleet_msgs::msg::TaskAssignment & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_fleet_msgs::msg::TaskAssignment & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs::msg::TaskAssignment;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::TaskAssignment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_fleet_msgs::msg::TaskAssignment *>(
    untyped_ros_message);
...
{
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_TaskAssignment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, TaskAssignment)() {
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_TaskAssignment__handle;
}
