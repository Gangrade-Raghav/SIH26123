...
#include "amr_fleet_msgs/msg/detail/task_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const amr_fleet_msgs::msg::TaskDefinition &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const amr_fleet_msgs::msg::TaskList & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: tasks
  {
    ...
    for (size_t i = 0; i < size; i++) {
      amr_fleet_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.tasks[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_fleet_msgs::msg::TaskList & ros_message)
{
  // Member: header
  ...
  // Member: tasks
  {
    ...
    for (size_t i = 0; i < size; i++) {
      amr_fleet_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: tasks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        amr_fleet_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: tasks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        amr_fleet_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TaskDefinition(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs::msg::TaskList;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: tasks
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      amr_fleet_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.tasks[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: tasks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        amr_fleet_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.tasks[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_fleet_msgs
max_serialized_size_key_TaskList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: tasks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        amr_fleet_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_TaskDefinition(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::TaskList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_fleet_msgs::msg::TaskList *>(
    untyped_ros_message);
...
static size_t _TaskList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TaskList(full_bounded, is_plain, 0);
...
{
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_TaskList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, TaskList)() {
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_TaskList__handle;
}
