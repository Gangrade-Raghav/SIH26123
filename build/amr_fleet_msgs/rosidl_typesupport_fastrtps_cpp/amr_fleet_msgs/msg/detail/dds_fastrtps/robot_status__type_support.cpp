...
#include "amr_fleet_msgs/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amr_fleet_msgs::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_fleet_msgs::msg::RobotStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: plan_epoch
  {
    size_t item_size = sizeof(ros_message.plan_epoch);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs::msg::RobotStatus;
    is_plain =
      (
      offsetof(DataType, cpu_load) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_fleet_msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, RobotStatus)() {
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
