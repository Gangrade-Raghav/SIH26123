...
#include "amr_fleet_msgs/msg/detail/compute_mode_event__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amr_fleet_msgs::msg::ComputeModeEvent & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.trigger_signal;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_fleet_msgs::msg::ComputeModeEvent & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_fleet_msgs
max_serialized_size_ComputeModeEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs::msg::ComputeModeEvent;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_fleet_msgs
max_serialized_size_key_ComputeModeEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::ComputeModeEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_fleet_msgs::msg::ComputeModeEvent *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ComputeModeEvent__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::ComputeModeEvent *>(
...
static size_t _ComputeModeEvent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputeModeEvent(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ComputeModeEvent__callbacks = {
  "amr_fleet_msgs::msg",
  "ComputeModeEvent",
...
static rosidl_message_type_support_t _ComputeModeEvent__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ComputeModeEvent__callbacks,
...
{
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_ComputeModeEvent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, ComputeModeEvent)() {
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_ComputeModeEvent__handle;
}
