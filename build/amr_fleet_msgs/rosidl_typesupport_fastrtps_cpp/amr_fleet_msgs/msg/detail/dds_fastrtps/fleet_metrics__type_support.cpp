...
#include "amr_fleet_msgs/msg/detail/fleet_metrics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amr_fleet_msgs::msg::FleetMetrics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_fleet_msgs::msg::FleetMetrics & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_fleet_msgs
max_serialized_size_FleetMetrics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_fleet_msgs::msg::FleetMetrics;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_fleet_msgs
max_serialized_size_key_FleetMetrics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::FleetMetrics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_fleet_msgs::msg::FleetMetrics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FleetMetrics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const amr_fleet_msgs::msg::FleetMetrics *>(
...
static size_t _FleetMetrics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FleetMetrics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FleetMetrics__callbacks = {
  "amr_fleet_msgs::msg",
  "FleetMetrics",
...
static rosidl_message_type_support_t _FleetMetrics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FleetMetrics__callbacks,
...
{
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_FleetMetrics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_fleet_msgs, msg, FleetMetrics)() {
  return &amr_fleet_msgs::msg::typesupport_fastrtps_cpp::_FleetMetrics__handle;
}
